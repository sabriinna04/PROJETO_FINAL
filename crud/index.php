...
<body>
    ...
    <div class="container">
        <a href="create.php"><button type="button" class="btn btn-labeled btn-succses">
    ...
    echo '<table class="table table-striped table-sm">';
        ...
        echo '<a href="edit.php?id='. $row['id'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="btn btn-warning fas fe-edit"></span></a>'; 
        echo " ";
